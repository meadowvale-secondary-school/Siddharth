...
let heartRateSum = heartRate1 + heartrate2 + heartrate3
let averageHeartRate = heartRateSum / 3
...
let heartRateSumD = heartRate1D + heartrate2D + heartrate3D
let averageHeartRateD = heartRateSumD / 3
print(averageHeartRateD)
