 ...
 */
var walkingChallenges = ["Walk to the nearest park and back home 5 times", "Walk 10 miles"]
var runningChallenges = ["Run up and down your street 10 times", "Run 5 miles"]
var jumpingChallenges = ["Do 25 squat jumps", "Do 100 calf hops"]
 ...
 */
var challenges = [walkingChallenges, runningChallenges, jumpingChallenges]
 ...
 */
var dedicatedChallenges = ["Walk 10 miles", "Run up and down your street 10 times", "Do 25 squat jumps"]

/*:
 Write an if statement that will use `isEmpty` to check if there is anything in the array. If there is not, print a statement asking the user to commit to a challenge. Add an else-if statement that will print "The challenge you have chosen is <INSERT CHOSEN CHALLENGE>" if the array count is exactly 1. Then add an else statement that will print "You have chosen multiple challenges."
 */
if dedicatedChallenges.isEmpty{
    print("It seems that you haven't chosen any challenges this week. Why don't you add one?")
}else if dedicatedChallenges.count == 1{
    print("The challenge you have chosen is \(dedicatedChallenges[0]).")
}else{
    print("You have chosen multiple challenges this week.")
}
