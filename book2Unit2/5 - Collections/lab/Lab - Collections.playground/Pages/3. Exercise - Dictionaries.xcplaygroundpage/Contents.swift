 ...
 */
if let numOfDays = months["January"]{
    print("January has \(numOfDays) days.")
}
...
var myDictionary: [String : [String]] = ["Shapes" : shapesArray, "Colours" : colorsArray]
print(myDictionary)
 ...
 */
if let lastElement = myDictionary["Colours"]{
    print(lastElement)
    print(lastElement[2])
}
