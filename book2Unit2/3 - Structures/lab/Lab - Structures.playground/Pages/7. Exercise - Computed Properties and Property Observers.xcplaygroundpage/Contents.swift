...
var aRect = Rectangle(width: 11, height: 17)
print(aRect.area)
...
struct Height {
    var heightInInches: Double {
        didSet {
            let valueInCM = heightInInches*2.54
            if heightInCentimeters != valueInCM{
                heightInCentimeters = valueInCM
            }
        }
    }
    ...
    var heightInCentimeters: Double {
        didSet{
            let valueInIN = heightInCentimeters/2.54
            if heightInInches != valueInIN{
                heightInInches = valueInIN
            }
        }
    }
...
var someHeight = Height(heightInCentimeters: 189)
print(someHeight)
someHeight.heightInCentimeters = 194
print(someHeight)
