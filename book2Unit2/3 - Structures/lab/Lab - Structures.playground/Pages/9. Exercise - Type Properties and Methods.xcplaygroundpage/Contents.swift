 ...
 */
struct User {
    static var currentUser: User = User(userName: "Siddharth", email: "SomeEmail@gmail.com", age: 17)
    var userName: String
    var email: String
    var age: Int
    ...
    static func logIn(user: User){
        currentUser = user
        print("\(User.currentUser.userName) is currently logged in.")
    }
}
 ...
 */
var newUser = User(userName: "Siddharth", email: "693981@pdsb.net", age: 17)
