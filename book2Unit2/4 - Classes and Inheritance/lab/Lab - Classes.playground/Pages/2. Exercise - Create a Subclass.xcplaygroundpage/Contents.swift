 ...
 */
// the variable weapon can't be used with falcon, since falcon was made using the base class, while weapon is a property of fighter, which is  a subclass of spaceship.
