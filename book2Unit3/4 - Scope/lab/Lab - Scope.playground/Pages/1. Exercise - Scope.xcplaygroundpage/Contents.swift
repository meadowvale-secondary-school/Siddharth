...
print("the variable 'foo' is defined inside a for loop (a closed scope) while the print statement on line 10 is outside the scope of the for loop, so it cannot access 'foo'.")
/*:
...
print("the variable 'x' is defined outside the for loop, (global scope) so it can be accessed at any point below it.")
...
print(greeting(greeting: "Hello there", name: "Simon"))
print(greeting(greeting: nil, name: "Shamir"))
/*:
