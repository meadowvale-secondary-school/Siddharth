 ...
 */
var someAge = checkAge(age: userInputAge)
print(someAge)
...
func checkPurchase(purchase: String) -> Double?{
    if let productStock = stock[purchase]{
        if productStock > 0{
...
let product = "Chips"
let check = checkPurchase(purchase: product)
print(check)
