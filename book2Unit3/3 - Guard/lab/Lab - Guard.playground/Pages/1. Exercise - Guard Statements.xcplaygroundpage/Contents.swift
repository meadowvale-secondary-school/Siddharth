...
print(calculateArea(x: 11.5, y: 17.2))
print(calculateArea(x: 0.2, y: -4))
...
func add(one: Int?, two: Int?) -> Int?{
    guard let newOne = one, let newTwo = two else{return nil}
    
    return newOne + newTwo
}

print(add(one: 17, two: 11))
print(add(one: 1, two: nil))
...
if let theUser = someUser{
    print("")
    print(theUser.firstName)
    print(theUser.lastName)
    print(theUser.age)
}
